...
if (!empty($render['views_landbook_thematics_related-block_4'])) {
  if (!isset($render['views_landbook_thematics_related-block_4']['#block']->region)) {
    $render['views_landbook_thematics_related-block_4']['#block']->region = -1;
  }
}
